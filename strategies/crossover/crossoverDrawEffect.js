...
const drawEffect = (state, action) => {
    ...
    if(event === 'crossover/draw') {
        ...
        drawToConsole({
            ...
            'Distance on Open': distanceOpen.map(value => value.toFixed(2)).join(', '),
