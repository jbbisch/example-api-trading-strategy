...
const drawEffect = (state, action) => {
    ...
    if(event === 'crossover/draw') {
        ...
        drawToConsole({
            ...
            distanceValley: distanceValley ? distanceValley.join(', ') : 'N/A',
