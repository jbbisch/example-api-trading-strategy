...
const startOrderStrategy = async (state, action) => {
    ...
    try {
        ...
        if(event === 'orderStrategy/startOrderStrategy') {
            ...
            const URL = `https://demo.tradovateapi.com/v1/orderstrategy/startorderstrategy`
            ...
            try {
                ...
                console.log('[startOrderStrategy] response:', response.data)
            } catch (error) {
                console.error('[startOrderStrategy] Error in startOrderStrategy FUNCTION CALL:', error)
                logger.error('[startOrderStrategy] Error in startOrderStrategy FUNCTION CALL:', error)
                }
