...
module.exports = function twoLineCrossover(shortPeriod, longPeriod) {
    function nextTLC(prevState, data) {
        ...
        const flatMarketEntryCondition = (flatVelocity && !velocityBreakingOut && currentPrice <= twentySma - 1.3 * stdDevTwentySma && currentPrice > twentySma - 1.8 * stdDevTwentySma)
        ...
        const flatMarketExitCondition = (flatVelocity && !velocityBreakingOut && currentPrice >= twentySma + stdDevTwentySma && currentPrice < twentySma + 1.5 * stdDevTwentySma)
