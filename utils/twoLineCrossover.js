...
module.exports = function twoLineCrossover(shortPeriod, longPeriod) {
    function nextTLC(prevState, data) {
        ...
        const velocityBreakoutCount = updatedLongSmaVelocities.slice(-3).filter(v => Math.abs(v) >= 0.00009000)
        const velocityBreakingOut = velocityBreakoutCount.length >= 2
        ...
        const flatMarketEntryCondition = false
        ...
        const next = {
            ...
            SMAPositiveCrossover: SMAPositiveCrossover,
            ...
            PTbandPeak: PTbandPeak,
            PTbandPeakExit: PTbandPeakExit,
            ptArmed: ptArmed,
            ptArmedBy: ptArmedBy,
