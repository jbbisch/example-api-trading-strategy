...
module.exports = function twoLineCrossover(shortPeriod, longPeriod) {
    function nextTLC(prevState, data) {
        ...
        const updatedAAGMpcHistory = [...prevState.AAGMpcHistory.slice(1), AcceleratingAbsoluteGapMomentumCrossover]
        ...
        const updatedSAGMncHistory = [...prevState.SAGMncHistory.slice(1), SlowingAbsoluteGapMomentumCrossover]
        ...
        const negativeCrossover =  SMANegativeCrossover || SAGMncBreak || GapMomentumLowCrossover || NegativeBounceNegativeCrossover || SlowingMomentumNegativeCrossover || MomentumPeakNegativeCrossover || DVncConfirmed || flatMarketExitCondition || DistancePeakNegativeCrossover || SharpDroppingVelocityNegativeCrossover
        ...
        const next = {
            ...
            SAGMncHistory: updatedSAGMncHistory,
            ...
            AAGMpcHistory: updatedAAGMpcHistory,
